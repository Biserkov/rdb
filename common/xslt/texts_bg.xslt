...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/02/xpath-functions" xmlns:xdt="http://www.w3.org/2005/02/xpath-datatypes">
	<xsl:output version="2.0" doctype-public="-//W3C//DTD HTML 4.01 Transitional//EN" doctype-system="http://www.w3.org/TR/html4/loose.dtd" encoding="windows-1251" indent="yes" omit-xml-declaration="no" media-type="text/html"/>
		...
		<html>
			...
			<body>
				<div id="holder" class="left">
					  ...
					  <p class="right">
						  <a>
							<xsl:attribute name="href"><xsl:text>../Multimedia/</xsl:text><xsl:value-of select="$sp"/><xsl:text>.html</xsl:text></xsl:attribute>
