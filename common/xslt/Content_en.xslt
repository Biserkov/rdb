		...
		<xsl:text disable-output-escaping="yes">
			...
			<xsl:if test="$tomba = 1">
				<xsl:text disable-output-escaping="yes">
						<![CDATA[
						<UL>
						<LI><OBJECT type="text/sitemap"><PARAM name="Name" value="vol I Растения и гъби"><PARAM name="Local" value="vol1\vol1.html"></OBJECT>
						<UL>
			...
			<xsl:if test="$tomba = 2">
				<xsl:text disable-output-escaping="yes">
						<![CDATA[	
						<UL>					
						<LI><OBJECT type="text/sitemap"><PARAM name="Name" value="vol II Животни"><PARAM name="Local" value="vol2\vol2.html"></OBJECT>
						<UL>
			...
			<xsl:if test="$tomba = 3">
				<xsl:text disable-output-escaping="yes">
						<![CDATA[
						<UL>
						<LI> <OBJECT type="text/sitemap"><PARAM name="Name" value="vol III Природни местообитания"><PARAM name="Local" value="vol3\vol3.html"></OBJECT>
						<UL>
